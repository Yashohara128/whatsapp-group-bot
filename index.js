...
client.on("message_create", async (message) => {
    try {
        ...
        // 📄 සිංහල Guide PDF එක යැවීම (Buffer Base64 ක්‍රමය සමඟ)
        ...
        // 📄 දෙමළ Guide PDF එක යැවීම (Buffer Base64 ක්‍රමය සමඟ)
        ...
        // 📄 ඉංග්‍රීසි Guide PDF එක යැවීම (Buffer Base64 ක්‍රමය සමඟ)
